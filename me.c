GNL est simple et laisse
peu de latitudes pour ajouter des bonus#
mais je suis certain que vous avez beaucoup d’imagination. Si vous avez réussi entièrement
et parfaitement la partie obligatoire.'\n' cette section propose quelques pistes pour aller plus
loin. Je repète, aucun bonus ne sera comptabilisé si la partie obligatoire n’est pas parfaite.
• Réussir\n get_next_line avec une seule variable statique.
...
puis une fois sur 5, etc, sans perdre le fil de la lecture sur chacun des descripteurs.w
